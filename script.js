const tips = [
  {
    ...
    tags: ["Survie", "Débutant", "1.20+"],
  },
  {
    title: "Astuce rapide",
    body:
      "Place des blocs transparents (dalles/verre) sur les portails du Nether pour éviter les spawns indésirables.",
    tags: ["Sécurité", "Nether", "Solo"],
  },
  {
    title: "Astuce redstone",
    body:
      "Un comparateur derrière un coffre détecte le niveau de remplissage pour un tri plus fiable.",
    tags: ["Redstone", "Tri", "Tech"],
  },
  {
    title: "Astuce build",
    body:
      "Varie les textures (bûches, escaliers, dalles) pour donner du relief aux façades.",
    tags: ["Build", "Design", "Créatif"],
  },
];
...
const backgroundChangeDelayMs = 7000;
...
if (form && formMessage) {
  form.addEventListener("submit", (event) => {
    ...
    if (!input || !input.value.includes("@")) {
      formMessage.textContent = "Ajoute une adresse email valide pour recevoir les astuces.";
      formMessage.dataset.state = "error";
      return;
    }

    formMessage.textContent = "Merci ! Ta place dans la newsletter est réservée.";
